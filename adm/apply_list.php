                ...
                <form name="fboardlist" id="fboardlist" method="post" onsubmit="return fboardlist_submit(this);" class="page-body">
                    ...
                    <div class="btn_fixed_top mt-4">
                        ...
                        <div class="top_btn-wrap" id="etc-pc">
                            ...
                            <a id="export_chks" class="btn btn-default float-right" href="email_form.php?menu=55">발송 이메일 관리</a>
                        ...
                        <table class="table border-bottom border-top" style="min-width: 2200px;">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" style="width: 150px;" class="text-center">A/B 테스트</th>
                                    ...
                                    <th scope="col" style="width: 200px;" class="text-center">창업희망지역</th>
                                    <th scope="col" style="width: 120px;" class="text-center">점포 보유</th>
